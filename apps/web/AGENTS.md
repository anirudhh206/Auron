...
**What is Auron?** A conversational AI payment app built on Solana that enables natural-language intent parsing via Claude AI. Users describe what they want ("send ₹500 to Priya", "lock my savings for 90 days", "scan QR and pay merchant"), and the system executes on Solana safely with a 6-layer security architecture. The blockchain is completely invisible to the user.
